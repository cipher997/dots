                        ...
                        <div className='header-right flex-1 flex relative perspective-[1000px]'>
                            ...
                            <nav className='user-nav perspective'></nav> */}
                                ...
                                <div className="right-nav flex ml-[15px] h-full items-center space-x-4">
                                    ...
                                    <a href="#" className="bg-red-500 hover:bg-red-600 text-white px-4 py-1 rounded-lg text-sm ">
                                        LogIn
                                    </a>
                                    <a href="#" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-1 rounded-lg text-sm ">
                                        SignUp
                                    </a>
                                </div>
                            </div>
